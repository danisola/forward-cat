...
index.footer.langs = Otros idiomas: <a href="/ca/">Català</a> - <a href="/">English</a>
...
confirm_deletion.deactivate = <a href="/es/delete?p={0}&h={1}" class="btn btn-primary">Elimínala!</a>
